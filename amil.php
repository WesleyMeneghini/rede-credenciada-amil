                            ...
                            if ($idEspecialidade > 0) {
                                ...
                                if ($err) {
                                    ...
                                    foreach ($prestadores as $prestador) {
                                        ...
                                        if (isset($prestador['nomePrestador'])) {
                                            $idEstabelecimento = 0;
                                            ...
                                            if ($nomePrestador != "" && $nomePrestador != "U" && $nomePrestador != "N" && $documento != "00.000.000/0000-00" && $nomePrestador != null) {
                                                ...
                                                if ($idEstabelecimento > 0) {
                                                    ...
                                                    foreach ($enderecos as $endereco) {
                                                        ...
                                                        if ($ddd1 > 0) {
                                                            ...
                                                            $telefone1 = Mask($tipoMask, $ddd1 . $fone1);
                                                        }
                                                        ...
                                                        $tipoMask = "telefone";
                                                        if (strlen($ddd2 . $fone2) == 11) {
                                                            $tipoMask = "celular";
                                                        }
                                                        $telefone2 = "";
                                                        if ($ddd2 > 0) {
                                                            $telefone2 = Mask($tipoMask, $ddd2 . $fone2);
                                                        }
